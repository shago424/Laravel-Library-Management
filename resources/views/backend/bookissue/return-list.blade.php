      ...
      <div class="container-fluid">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Return Issue Book List</li>
            </ol>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <tr style="background-color: ">
                    ...
                    <span style="padding: 10px" class="badge badge-danger">Delivered</span>
                      ...
                      <td>
                          ...
                          <a style="padding: 8px" id="return" href="{{route('issuebooks.return',$issue->id)}}" class="btn  btn-success btn-xs mr-2"> <i class="fa fa-undo"> Return</i></a>
