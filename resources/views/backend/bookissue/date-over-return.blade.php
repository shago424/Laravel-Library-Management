      ...
      <div class="container-fluid">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Return Date Over List</li>
            </ol>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <section class="col-md-12">
           ...
           <div class="card" style="border:5px solid lightgray">
            ...
            <tr style="background-color: ">
                      ...
                      <td style="background-color: red;color: white">{{date('d-m-Y',strtotime($issue->limit_date))}}</td>
