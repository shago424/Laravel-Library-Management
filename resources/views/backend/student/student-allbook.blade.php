      ...
      <div class="container-fluid">
        ...
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Student Book List</li>
            </ol>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
           ...
           <div class="card" style="border:5px solid lightgray">
            ...
            <div class="card-body">
              <table id="" class="table table-bordered table-hover table-sm" width="100%">
                 <tr >
                   <th  style="font-size: 20px;padding: 8px;text-align: center;" colspan="9">Student Information </th>
                 </tr>
                   <tr style="background-color: #AF2136;color: white">
                    <th>Student ID</th>
                    <th>Student Name</th>
                    <th>Class Name</th>
                    <th>Group Name</th>
            ...
            <tr style="background-color: ">
                      <td style="text-align:center; ">{{$allbooks['0']['student']['id']}}</td>
                      <td>{{$allbooks['0']['student']['name']}}</td>
                       <td>{{$allbooks['0']['student']['name']}}</td>
                      <td>{{$allbooks['0']['student']['name']}}</td>
                      <td>{{$allbooks['0']['student']['name']}}</td>
                      <td>{{$allbooks['0']['student']['name']}}</td>
                      <td>{{$allbooks['0']['student']['name']}}</td>
                      <td>{{$allbooks['0']['student']['mobile']}}</td>
                      <td>{{$allbooks['0']['student']['email']}}</td>
                    </tr>
                </table>
              ...
              <br> <br>
                ...
                <table id="example1" class="table table-bordered table-hover table-sm" width="100%">
                  <thead>
                    <tr>
                   <th  style="font-size: 20px;padding: 8px;text-align: center;" colspan="12">Student Book Details </th>
                 </tr>
            ...
            <tr style="background-color: ">
                      ...
                      <td>{{$issue['user']['role']['role_name']}}</td>
