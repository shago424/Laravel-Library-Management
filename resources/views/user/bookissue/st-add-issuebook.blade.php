...
<!-- Content Wrapper. Contains page content -->
        ...
        <div class="row">
          ...
          <section class="col-md-12 offset-md-0">
           ...
           <div class="card">
              ...
              Add Book Issue
              @endif
                  <a style="font-weight: bold;font-size: 18px" href="{{route('showbooks.show-book-view')}}" class="btn btn-warning btn-sm float-right"><i class="fa fa-eye"> Choice Your Book</i></a>
                </h5>
              </div> 
  ...
  <form method="POST" action="{{(@$editdata)?route('students.allbook-issue-update',$editdata->id):route('students.allbook-issue-store')}}"
  id="myform">
    @csrf
   <div class="row">
